                ...
                while ($startTime->lt($repeatEndDate)) {
                    ...
                    if($repeatType == 'weekly' && !empty($repeatOn)) {
                        ...
                        foreach ($repeatOn as $day) {
                            ...
                            $session['start_time'] = $sessionStartTime->toDateTimeString();
                            $session['end_time'] = $sessionStartTime->add($duration)->toDateTimeString();
                        ...
                        $session['start_time'] = $startTime->toDateTimeString();
                        $session['end_time'] = $startTime->copy()->add($duration)->toDateTimeString();
