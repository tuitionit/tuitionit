...
@section('content')
    {{ Form::model($room, ['route' => ['admin.rooms.update', $room], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'put']) }}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-sm-8">
                                    {{ Form::checkbox('has_blackboard', '1') }}
                                </div><!--col-lg-1-->
                            </div><!--form control-->
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-md-4">
                                    {{ Form::checkbox('has_whiteboard', '1') }}
                                </div><!--col-lg-1-->
                            </div><!--form control-->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-md-4">
                                    {{ Form::checkbox('is_airconditioned', '1') }}
                                </div><!--col-lg-1-->
                            </div><!--form control-->
                        </div>
                    </div>
                ...
                <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-md-4 col-md-offset-2 col-lg-2 col-lg-offset-6">
                            {{ link_to_route('admin.locations.show', trans('buttons.general.cancel'), [$room->location], ['class' => 'btn btn-default btn-block']) }}
                        </div>
