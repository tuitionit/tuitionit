...
@section('content')
    {{ Form::model($course, ['route' => ['admin.courses.update', $course], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'put']) }}
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    @include('backend.includes.partials.courses-header-buttons')
