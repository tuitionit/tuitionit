...
@section('content')
    {{ Form::model($assignment, ['route' => ['admin.assignments.update', $assignment], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'put']) }}
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group {{ $errors->first('description', 'has-error') }}">
                        ...
                        <div class="col-lg-10">
                            {{ Form::text('description', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.assignments.description')]) }}
                        </div><!--col-lg-10-->
                    </div><!--form control-->

                    <div class="form-group">
                        {{ Form::label('status', trans('validation.attributes.backend.assignments.active'), ['class' => 'col-lg-2 control-label']) }}
